...
from backend_model import (SnifferLlamaModel,SnifferQwen2Model,SnifferGemmaModel,SnifferMistralModel,SnifferGPTNeoModel)
from backend_t5 import T5

MODEL_MAPPING_NAMES = OrderedDict([
    ("llama", SnifferLlamaModel),
    ("gemma", SnifferGemmaModel),
    ("mistral", SnifferMistralModel),
    ("qwen2.5", SnifferQwen2Model),
